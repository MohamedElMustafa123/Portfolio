...
export default function Footer() {
  ...
  return (
    <>
      ...
      {/*customizing icon sizes here */}
      <footer className="footer-bar">
        <div className="footer-social-links">
          <a href="https://www.linkedin.com/in/mustafa-abdallah-006639291/" target="_blank" rel="noopener noreferrer" className="social-link linkedin-link">
          ...
          <a href="https://github.com/MohamedElMustafa123" target="_blank" rel="noopener noreferrer" className="social-link github-link">
            <svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 24 24" fill="currentColor">
